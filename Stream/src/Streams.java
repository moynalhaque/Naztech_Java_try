...
public class Streams {
  public static void main(String[] args) {
    List<Employee> persons = Employee.perso();
    // Find any male
...
class Employee {
  ...
  public Employee(long moinal, String name, Gender gender, LocalDate dob,
      double income) {
    this.id = moinal;
    this.name = name;
    this.gender = gender;
  ...
  public static List<Employee> perso() {
    Employee p1 = new Employee(1, "moinal", Gender.MALE, LocalDate.of(1971,
